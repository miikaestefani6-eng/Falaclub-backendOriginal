...
const rootRouteChildren: RootRouteChildren = { IndexRoute, LoginRoute, MiaRoute, HojeRoute, BibliotecaRoute, FlashcardsRoute, DropsRoute, ProgressoRoute, OnboardingRoute }
